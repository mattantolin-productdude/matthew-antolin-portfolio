...
const links = [
  {
    label: "Email",
    href: "mailto:mattantolin@gmail.com",
    display: "mattantolin@gmail.com",
    external: false,
  },
  {
    label: "LinkedIn",
          ...
          {links.map(({ label, href, display, external }) => (
            ...
            >
              <div>
                ...
                <p className="text-sm font-medium text-zinc-900 group-hover:text-amber transition-colors">
                  {display}
                </p>
              </div>
              <span className="text-zinc-300 group-hover:text-amber/70 transition-colors">
                →
              </span>
            </a>
          ))}
